...
export const Filter = ({setFilterState}: { setFilterState: SetFilterState }) => {
    ...
    useEffect(() => setFilterState({oslo, trondheim, alle, kommende, tidligere, mine, apent, lukket}), [oslo, trondheim, alle, kommende, tidligere, mine, apent, lukket])

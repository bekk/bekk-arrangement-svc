...
task_environment = {
  ...
  Sendgrid__Dev_White_List_Addresses = "bjorn.ivar.strom@bekk.no, hong.nhung.thi.vo@bekk.no, ingrid.larssen@bekk.no, trond.tenfjord@bekk.no, ole.magnus.lie@bekk.no, gunvor.lemvik@bekk.no, ferdinand.loberg@bekk.no, mari.talmoen@bekk.no, frederik.heggenes@bekk.no"
}
task_secrets = [
